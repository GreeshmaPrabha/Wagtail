# Generated by Django 5.0.7 on 2024-10-11 12:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Media Index Pages',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', wagtail.fields.StreamField([('media_block', wagtail.blocks.StructBlock([('heading', wagtail.blocks.CharBlock(help_text='Add your heading', required=False)), ('content', wagtail.blocks.ListBlock(wagtail.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=False)), ('posted_date', wagtail.blocks.CharBlock(help_text='Posted date', required=False)), ('description', wagtail.blocks.RichTextBlock(editor='default', help_text='Add additional text', required=False))]), help_text='Add multiple news to this section', label='Add text card'))]))], blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_items', to='more_media.mediapage')),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(blank=True, help_text='A comma-separated list of tags.', through='more_media.MediaPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
    ]
