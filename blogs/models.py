...
# This is the Blog page for Blog. It inherits from BasePage and BannerMixin.
# It holds introductory and body content and has a max count restriction of 1 page.
class BlogIndexPage(BasePage, BannerMixin):
    ...
    subpage_types = ['blogs.BlogPage']  # Only AwardPage can be created as a subpage
...
# Model for tagging BlogPage using Wagtail's tagging system
class BlogPageTag(TaggedItemBase):
    # Relation to BlogPage model
...
# The main BlogPage model that contains all content for individual award posts
class BlogPage(ViewCountMixin, BasePage, BannerMixin):
