# Generated by Django 5.0.7 on 2024-10-11 12:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blogs', wagtail.fields.StreamField([('blog_block', wagtail.blocks.StructBlock([('heading', wagtail.blocks.CharBlock(help_text='Add your heading', required=False)), ('content', wagtail.blocks.ListBlock(wagtail.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=False)), ('posted_date', wagtail.blocks.CharBlock(help_text='Posted date', required=False)), ('description', wagtail.blocks.RichTextBlock(editor='default', help_text='Add additional text', required=False))]), help_text='Add multiple news to this section', label='Add text card'))]))], blank=True, null=True)),
