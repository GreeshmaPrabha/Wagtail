...
from .models import AmenitiesIndexPage,AmenitiesPage
...
class AmenitiesViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return AmenitiesPage.objects.live().exact_type(AmenitiesPage).filter(locale=locale)
